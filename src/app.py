...
activities = {
    ...
    "Swimming Club": {
        "description": "Swim training and lifeguard skills for all levels",
        "schedule": "Wednesdays and Fridays, 3:30 PM - 5:00 PM",
        "max_participants": 20,
        "participants": ["ava@mergington.edu"]
    },
    "Painting Club": {
        "description": "Explore painting techniques and create artwork together",
        "schedule": "Mondays, 3:30 PM - 5:00 PM",
        "max_participants": 18,
        "participants": ["isabella@mergington.edu", "mia@mergington.edu"]
    },
    "Drama Club": {
        "description": "Acting, stage production, and theatre workshops",
        "schedule": "Thursdays, 4:00 PM - 6:00 PM",
        "max_participants": 25,
        "participants": ["charlotte@mergington.edu"]
    },
    "Debate Team": {
        "description": "Prepare for debate tournaments and develop public speaking skills",
